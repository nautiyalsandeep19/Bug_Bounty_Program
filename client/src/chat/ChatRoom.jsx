...
const ChatRoom = () => {
  ...
  return (
    <div className="">
      <ReportData reportId={reportId} />
      <div className="ProseMirror space-y-2  w-full max-h-[500px] min-h[200px] rounded-lg border-1 border-green-500 overflow-y-auto  m-auto min-h-30 bg-secondarybg">
