// components/ProgramTypeModal.jsx
...
const PROGRAM_TYPES = [
  ...
  },
  {
    ...
    description: "Incentivizes researchers to find and report vulnerabilities in our public-facing systems",
    type: "Public Bug Bounty",
    icon: <Bug className="w-6 h-6 text-white" />,
  },
  {
    title: "Enterprise Pentesting",
    description: "Rapid, SaaS-based infrastructure facilitating regular testing to fortify system security",
  ...
  return (
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center z-50">
      <div className="bg-[#1E1E1E] p-6 rounded-xl shadow-xl w-full max-w-xl mx-auto">
        <h2 className="text-xl font-semibold text-white mb-4">Select Program Type</h2>
