  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="flex border-b border-gray-200 mb-6">
        <button
          className={`py-2 px-4 font-medium ${activeTab === 'published' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'}`}
          onClick={() => setActiveTab('published')}
        >
          Published Programs
        </button>
        <button
          className={`py-2 px-4 font-medium ${activeTab === 'draft' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500'}`}
