...
const ProgramCard = ({ program }) => {
  ...
  return (
    <div
      ...
      onClick={() => navigate( `/${userType}/programsmaindetails/${program._id}`)}
    >
  ...
  {program.type}
      ...
      <div className="flex justify-center mb-6">
        <div className="w-24 h-24 rounded-full border-4 border-blue-500 flex items-center justify-center bg-[#1e293b] shadow-inner">
          <img
            src={'https://images.unsplash.com/photo-1545231027-637d2f6210f8?q=80&w=2448&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
            alt={program.name}
