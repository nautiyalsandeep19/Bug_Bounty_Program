...
//   return (
//     <div className="w-full bg-[#111f3a] text-white p-6 rounded-lg shadow-[inset_0px_-1px_0px_0px_#FFFFFF2E] flex flex-col gap-5">
...
//             <div key={field}>
//               <label className="text-sm mb-1 block text-gray-400 capitalize">
//                 {field}
//               </label>
//               <input
//                 type="text"
...
//                 className="w-full p-3 bg-[#0F172A] text-gray-400 rounded-lg"
//               />
//             </div>
//           ))}
//         </div>
...
//           </div>
//           <div className="flex text-lg gap-2">
//             <span className="font-medium text-white capitalize">position:</span>
//             <span>{contactPerson.position || 'N/A'}</span>
//           </div>
//           <div className="flex text-lg gap-2">
//             <span className="font-medium text-white capitalize">phone:</span>
//             <span>{contactPerson.phone || 'N/A'}</span>
//           </div>

//           {/* Display domain separately */}
//           <div className="flex text-lg gap-2">
//             <span className="font-medium text-white capitalize">domain:</span>
...
//         ) : (
//           <Button onClick={() => setEdit(true)} text="Edit" />
//         )}
//       </div>
//     </div>
//   )
